...
cleaned_words = set([''.join(sym.lower() for sym in word if sym.isalpha()) for word in words])
cleaned_words_less_four = {word for word in cleaned_words if len(word) < 4}
print(*sorted(cleaned_words_less_four))