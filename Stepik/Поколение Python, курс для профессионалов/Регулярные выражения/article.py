from re import finditer, MULTILINE, IGNORECASE
...
counter_1 = sum(1 for _ in finditer(r'^stepik', article, flags=IGNORECASE|MULTILINE))
counter_2 = sum(1 for _ in finditer(r'\.\.\.$|!$', article, flags=IGNORECASE|MULTILINE))
